...
var TodosService = (function () {
    ...
    TodosService.prototype.getTodo = function () {
        return this._http.get('/api/v1/todo').map(function (res) { return res.json(); });
    };
    TodosService.prototype.saveTodo = function (text) {
